...
syn keyword	cStatement where 
syn keyword	cLabel		mixin of let required optional initializes
syn keyword cInclude begin end include
syn keyword	cConditional	if else 
syn keyword	cRepeat		while return
syn keyword cType   new override abstract this super 
syn keyword	cIncluded		void null
